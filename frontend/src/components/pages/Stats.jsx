...
function Stats() {
	...
	useEffect(async () => {
		...
		setLoading(true);
		setLoading(false);
		fetch(`http://localhost:8080/profile/stats/${category}/${sort}`, {
			method: "PUT",
			headers: {
	...
	return (
		<>
			<ToggleButtonGroup type="radio" name="options" defaultValue={"type"}>
				<ToggleButton
			...
			<ToggleButtonGroup type="radio" name="options" defaultValue={"total"}>
				<ToggleButton
