...
@Qualifier("artYearFinishedStatsService")
@Service
public class ArtYearFinishedStatsService extends StatsService<ArtYearFinished>{
	...
	@Autowired
	public ArtYearFinishedStatsService(UserPreferencesRepository repository, UserService user) {
