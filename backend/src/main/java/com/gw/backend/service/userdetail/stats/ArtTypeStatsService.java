...
@Qualifier("ArtTypeStatsService")
@Service
public class ArtTypeStatsService extends StatsService<ArtType>{
	...
	@Autowired
	public ArtTypeStatsService(UserPreferencesRepository repository, UserService user) {
